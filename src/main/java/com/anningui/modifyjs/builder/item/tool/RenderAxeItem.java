...
public class RenderAxeItem extends AxeItem {
    ...
    public RenderAxeItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties, Multimap<ResourceLocation, AttributeModifier> attributes) {
